...
def parse_args():
    ...
    # Device selection
    # - auto: prefer CUDA (NVIDIA) then MPS (Apple Silicon) then CPU
    # - mps: force Apple Silicon GPU (Metal)
    # - cpu/cuda: force specific backend
    parser.add_argument(
        '--device',
        choices=['auto', 'cpu', 'mps', 'cuda'],
        default='auto',
        help='Compute device backend (default: auto)'
    )
