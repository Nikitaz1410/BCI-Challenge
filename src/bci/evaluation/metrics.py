...
"""
def compute_ece(y_true, y_prob, model="", features="", n_bins=10):
    # good article https://towardsdatascience.com/expected-calibration-error-ece-a-step-by-step-visual-explanation-with-python-code-c3e9aa12937d/

    Compute Expected Calibration Error (ECE) using y_prob as confidence.

    y_true: array of shape (N,), labels {0,1}
    y_prob: array of shape (N,), predicted probabilities (confidence)
    ...
    # print(f"ECE, {model}, {features}: {ece:.4f}")
